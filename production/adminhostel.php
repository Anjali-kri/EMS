...
if (isset($_POST["save"]))
{
 ...
 $q="insert into adminroom values('$block','$floor','$room',)";
...
<div class="row">
		 ...
		 <label>Block<span>*</span></label> 
		  <input type="text" class="form-control" name="block"   id="block" onchange="getfloor(this.value)">  
		 		                         ...
		 		                         <select class="select2_multiple form-control" style="padding:0px" name="block"> 
                    
 <?php
						 $r=mysqli_query($con,"select distinct block from room");
						 ?>
