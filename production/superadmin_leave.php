...
<head>
  ...
  $result=mysqli_query($con,"select * from emp_leave where L1_status='0'||L1_status='1'||L1_status='2' ");
  ...
  $total_aprove=mysqli_num_rows($result_a);
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title" >
				  ...
				  <?php
				 $result=mysqli_query($con, "select * from emp_leave where 	L1_status='2'");
				  $id=1;
				 while( $fetch=mysqli_fetch_assoc($result))
				 {
				  ...
				  <td><a href="check_leave.php?aprove_super=<?php echo $fetch['leave_code'];?>" class="btn btn-success" style="border-radius:10px" name="aprove">Aprove</a> </td>
				  <td><a href="check_leave.php?reject_super=<?php echo $fetch['leave_code'];?>" class="btn btn-danger" style="border-radius:10px" name="reject">Reject</a> </td>
				 <?php
				 //mysqli_query()
