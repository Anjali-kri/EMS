...
if(isset($_POST['save']))
{
	...
	$q="insert into additem(Item,Itemcategory,Description)values('$Item','$Itemcategory','$Description')";
    ...
    <div class="main_container">
     <?php include"sidebar.php"?> 
      ...
      <!-- page content -->
            ...
            <div class="x_panel">
            <div class="x_title">
            <h2 style="color:#0077b3"><b>ADD ITEM</b></h2>
		  ...
		  ?>
            ...
            <div class="x_panel">
            <div class="x_title">
            <h2 style="color:#0077b3"><b>ITEM LIST</b></h2>
...
if($search!="")
{	
$sql="select * from additem where id='$search'";					  
