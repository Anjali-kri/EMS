    ...
    <div class="modal-dialog">
		...
		<div class="form-group">
					...
					<label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Name</label>
                      <div>
                        <input id="middle-name" type="text" name="name" value="<?php echo "##" ?>">
                      </div>
                    </div><br>
					<div class="form-group">
					<label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">library Number</label>
                      <div>
                        <input id="middle-name" type="text" name="lib_name" value="<?php echo $fetch['lib_no']; ?>">
                      </div>
                    </div><br>
					<div class="form-group">
					<label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Book id</label>
                      <div>
                        <input id="middle-name" type="text" name="b_id" value="<?php echo $fetch['book_id']; ?>">
                      </div>
                    </div><br>
					<div class="form-group">
					...
					<label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Return Date</label>
					 ...
					 date_default_timezone_set('Asia/Kolkata');
						$today = date("d-m-Y ");
					  ?>
                        <input id="middle-name" type="text" name="r_date" value="<?php echo $today; ?>" readonly>
                      </div>
                    </div><br>
					<div class="form-group">
					<label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Fine </label>
                      <div>
						...
						<input id="middle-name" type="text" name="time"  value="<?php  echo date('h:i');?>">
                      </div>
                    </div><br>
					  <?php
										  ...
										  $b_id=$_POST['b_id'];
										  echo $b_id;
										  $sql="update  issue_book_detail set retun_date='$r_date', time='$time' where book_id='$b_id'";
										   $fetch1= mysqli_query($con,$sql);
										  }
										?>
					
        </div>
        <div class="modal-footer">
        <button type="submit" class="btn btn-success" name="updatedata">Return Book</button>
