...
<body class="nav-md">
  ...
  <?php include"footer.php"?> 
          ...
          <div class="title_left">
            ...
            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Issue By">Student Name<span class="required">*</span>
            </label>
            ...
            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Issue By">Address<span class="required">*</span>
            </label>
            <div class="col-md-10 col-sm-10 col-xs-12">
            <input type="text" id="Issue To" name="Issueto" required="required" class="form-control col-md-7 col-xs-12">
            </div>
			...
			<div class="col-sm-4">
            <div class="form-group"><br>
            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Issue By">City<span class="required">*</span>
            </label>
            <div class="col-md-10 col-sm-10 col-xs-12">
