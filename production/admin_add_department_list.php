            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title" >
				  ...
				  {
					?> <span  class="output1"> Data Save failed</span>  <?php  
				  }
				  }
				  ...
				  <input type="text" class="T1" name="dept_name" autocomplete="off"><br><br>
				  <label class="L2">Department short Name</label><br>
				  <input type="text" class="T2" name="dept_short_name" autocomplete="off"><br><br>
