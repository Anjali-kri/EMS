...
if (isset($_POST["save"]))
{
   ...
   $room=$_POST['room'];
   $i=1;
   echo $room_no=$block.$floor.trim($i);
    
   while($room>=$i)
   {
	   $room_no=$block.$floor.$i;
	   
	   $q="insert into adminroom values('$block','$floor','$room','$room_no')";
...
<form method="post">
 ...
 <h2> <span class="glyphicon glyphicon-search">&nbsp;</span>Room Details</h2>	
		 ...
		 <label>Room<span>*</span></label> 
		  ...
		  <hr>
			 ...
			 <div class="col-sm-4">
			  ...
			  <div class="col-sm-4">
			  <input type="submit"value="SAVE" name="save" style='background-color:#9f8ad1;color:white ;border-radius:15px'>	
