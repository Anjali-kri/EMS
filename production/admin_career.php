...
<head>
 ...
 include("head1.php");
  ...
  $from=$_POST['from'];			
  $to=$_POST['to'];
  $sql1="select * from career where date between '$from' and '$to' ";
	      ...
	      <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
			   ...
			   <div class="row">
			   <div class="col-sm-12">
			   <button class="btn btn-info btn-lg-5 btn-block" name="search"><i class="fa fa-search" style="color:white; font-size:25px"></i>&nbsp;&nbsp;&nbsp;<b style="font-size:25px">Search</b></button>
			   </div>
              ...
              <div class="x_panel">
				...
				else if(isset($_POST['search']))
				{
				  ...
				  $sql1="select * from career where date between '$from' and '$to' ";
					...
					<td><?php echo $fetch1['phone']; ?></td>
					<td><?php echo $fetch1['dob']; ?></td>
					<td><?php echo $fetch1['seeking']; ?></td>
					<td><?php echo $fetch1['skill']; ?></td>
					<td><?php echo $fetch1['experience']; ?></td>
					<tr>
					<?php
					}
