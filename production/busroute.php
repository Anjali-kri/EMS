...
if(isset($_POST['save']))
{
	$busno=$_POST['busno'];
	$route=$_POST['route'];		
	$q="insert into busroute(busno,route)values('$busno','$route')";	
  ...
  <?php include"footer.php"?> 
          ...
          <div class="title_left">
			...
			<div class="clearfix">
               ...
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="busno">BusNo.<span class="required">*</span>
               </label>
               <div class="col-md-5 col-sm-5 col-xs-12">
               <input type="text" id="busno" name="busno" required="required" class="form-control col-md-7 col-xs-12">
               </div>
               </div>
			   
			   
		  <div class="form-group">
		  <label class="control-label col-md-3 col-sm-3 col-xs-12">Routes<span class="required">*</span></label>
          <div class="col-md-5 col-sm-5 col-xs-12">                      
