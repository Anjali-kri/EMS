                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
				   <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="book_id" value="<?php echo $book_id;  ?>" readonly>
                      </div>
                    </div>
					<div class="form-group">
                      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Book Name</label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="book_name" class="form-control col-md-7 col-xs-12" type="text" name="book_name" value="<?php echo $book_name1; ?>" readonly >
                      </div>
                    </div>
					<div class="form-group">
