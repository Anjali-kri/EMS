...
$sql="select * from userinformation where busnumber='$id'";
...
{
$busname=$_POST['regno '];
$inchargeperson=$_POST['route'];
$expense =$_POST['busnumber'];
$servicedate=$_POST['stopage'];
$sql=" update  userinformation set regno='$regno',route='$route',busnumber='$busnumber',stopage='$stopage' where busnumber='$id'";
